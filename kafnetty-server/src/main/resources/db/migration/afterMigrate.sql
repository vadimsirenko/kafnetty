...
VALUES
    ...
    ('2bd09cbf-ef16-469f-82ab-f51ae9913aa0','92aeaf7c-39e3-49a7-b69a-18de73efb479','Олег', '2bd09cbf-ef16-469f-82ab-f51ae9913aa0', 'Just use overflow: auto. Since your content by default just breaks to the next line when it cannot fit on the current line, a horizontal scrollbar won''t be created (unless it''s on an element that has word-wrapping disabled). For the vertical bar,it will allow the content to expand up to the height you have specified. If it exceeds that height, it will show a vertical scrollbar to view the rest of the content, but will not show a scrollbar if it does not exceed the height.',1698398477040),
